...
namespace MaxIncreaseArray
{
    class MaxIncreaseArray
    {
        ...
        static void Main()
        {
            ...
            int[] defaultArray = { 3, 2, 3, 4, 2, 2, 4 }; // this line is changed compared to exercise 4 :)
            int[] array = {};
            ...
            {
                if (array[index] == startElement + 1) // this line is changed compared to exercise 4 :)
                {
                    numberOfElements++;
                    startElement++;                 // this line is new compared to exercise 4 :)
                }
                else
                {
