namespace TestPoker
{
    ...
    [TestClass]
    public class TestIsThreeOfAKindMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithNoCards);
        }
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithFiveDifferentCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualOfFiveCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithSixDifferentCards);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualCard);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithFiveEqualCards);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualPairOfCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualOfFourCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualOfSixCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsThreeOfAKind(handWithTwoEqualOfSixCardsOnEqualSuit);
        }
