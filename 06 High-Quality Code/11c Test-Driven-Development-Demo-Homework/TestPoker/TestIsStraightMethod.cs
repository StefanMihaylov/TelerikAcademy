namespace TestPoker
{
    ...
    [TestClass]
    public class TestIsStraightMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var result = this.checker.IsStraight(handWithNoCards);
        }
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsStraight(handWithFiveDifferentCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithHighCard_1()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualOfSixCardsOnEqualSuit);
            Assert.IsFalse(result);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualOfFiveCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var result = this.checker.IsStraight(handWithSixDifferentCards);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualCard);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var result = this.checker.IsStraight(handWithFiveEqualCards);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualPairOfCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualOfFourCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var result = this.checker.IsStraight(handWithTwoEqualOfSixCards);
        }
