namespace TestPoker
{
    ...
    [TestClass]
    public class TestIsFlushMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var result = this.checker.IsFlush(handWithNoCards);
        }
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsFlush(handWithFiveDifferentCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualOfFiveCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var result = this.checker.IsFlush(handWithSixDifferentCards);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualCard);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var result = this.checker.IsFlush(handWithFiveEqualCards);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualPairOfCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualOfFourCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualOfSixCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsFlush(handWithTwoEqualOfSixCardsOnEqualSuit);
        }
