namespace TestPoker
{
    ...
    [TestClass]
    public class TestIsStraightFlushMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithNoCards);
        }
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithFiveDifferentCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithHighCard_1()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualOfSixCardsOnEqualSuit);
            Assert.IsFalse(result);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualOfFiveCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithSixDifferentCards);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualCard);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithFiveEqualCards);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualPairOfCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualOfFourCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var result = this.checker.IsStraightFlush(handWithTwoEqualOfSixCards);
        }
