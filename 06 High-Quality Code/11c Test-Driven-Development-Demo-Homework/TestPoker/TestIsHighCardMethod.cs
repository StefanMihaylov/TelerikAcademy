namespace TestPoker
{
    ...
    [TestClass]
    public class TestIsHighCardMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithNoCards);
        }
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsHighCard(handWithFiveDifferentCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualOfFiveCardsOnEqualSuit);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithSixDifferentCards);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualCard);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithFiveEqualCards);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualPairOfCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualOfFourCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualOfSixCards);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
        {
            ...
            var result = this.checker.IsHighCard(handWithTwoEqualOfSixCardsOnEqualSuit);
        }
